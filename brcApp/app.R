...
#loading files
file <- read.delim('./Files_data/sif_cbioportal_brca.tsv', header = TRUE,stringsAsFactors = FALSE)
file2 <- read.delim('./Files_data/snvs_raw_data.tsv', header = TRUE, stringsAsFactors = FALSE)
ensembl <- read.delim('./Files_data/mart_export_GRCh38p13.tsv',check.names = F,stringsAsFactors = F)
goi <- readLines('./Files_data/genes_of_interest.txt')
load('./Files_data/scna_data.RData')
